...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Course.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSIT", "BSBA", "BSCRIM", "BSEDUC", "BSOA" }));
        ...
        jCheckBox2.setText("Playing Online Games");
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        String male = radiobtnMale.getText();
        String female = radiobtnFemale.getText();
        String gay = radiobtnGay.getText();
